                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('events.update', $event->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_event') is-invalid @enderror" id="deskripsi_event" name="deskripsi_event" rows="3" required>{{ old('deskripsi_event', $event->deskripsi_event) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            @if ($event->gambar)
                                <img src="{{ asset('storage/events/' . $event->gambar) }}" alt="{{ $event->nama_event }}" class="img-thumbnail mt-2" width="150">
                            @endif
                            @error('gambar')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('jam_event') is-invalid @enderror" id="jam_event" name="jam_event" value="{{ old('jam_event', $event->jam_event) }}" required>
                            @error('jam_event')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tgl_event') is-invalid @enderror" id="tgl_event" name="tgl_event" value="{{ old('tgl_event', $event->tgl_event) }}" required>
                            @error('tgl_event')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" value="{{ old('lokasi', $event->lokasi) }}" required>
                            @error('lokasi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('jml_ticket') is-invalid @enderror" id="jml_ticket" name="jml_ticket" value="{{ old('jml_ticket', $event->jml_ticket) }}" required>
                            @error('jml_ticket')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('hrg_ticket') is-invalid @enderror" id="hrg_ticket" name="hrg_ticket" value="{{ old('hrg_ticket', $event->hrg_ticket) }}" required>
                            @error('hrg_ticket')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

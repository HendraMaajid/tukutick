    ...
    <div class="container-fluid bg-light py-5">
      <div class="container">
        ...
        <div class="text-center mb-5">
          <h1 class="display-4 fw-bold text-primary mb-3">Upcoming Events</h1>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-12">
                    <form id="searchForm" action="{{ route('landing.search') }}" method="POST" class="bg-white rounded-4 shadow-sm p-4 border">
                        @csrf
      ...
      <div class="py-5">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="bg-primary rounded-4 p-5 text-white position-relative overflow-hidden">
  ...
  <script>
      $(document).ready(function() {
        ...
        function loadAllEvents() {
            ...
            $.ajax({
                url: "{{ route('landing.events') }}", // Create this route for loading all events
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
